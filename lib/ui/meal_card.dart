...
//                        color: Colors.yellow[200],
                        child: _Header(_mealData),
                      ),
                      Row(children: <Widget>[
                        Expanded(child: _Image(imageUrl:_mealData['imageUrlHttps']),),
                        Expanded(child: (
                          Column(
                            crossAxisAlignment: CrossAxisAlignment.start,
                            children: <Widget>[
                              Container(
                                child: getFavoriteWidgets(_mealData['favorite']),
                              ),
                              Container(
//                                color: Colors.red[50],
                                margin: EdgeInsets.only(left: 10),
                                padding: EdgeInsets.symmetric(vertical: 5),
                                child: Text("症状：" + _mealData['status']),
                              ),
                              Container(
//                                color: Colors.red[100],
                                margin: EdgeInsets.only(left: 10),
                                padding: EdgeInsets.symmetric(vertical: 5),
                                child: Text("場所：" + _mealData['location']),
                              ),
                              Container(
//                                color: Colors.red[200],
                                margin: EdgeInsets.only(left: 10),
                                padding: EdgeInsets.symmetric(vertical: 5),
                                child: Text("備考：" + _mealData['note']),
                              ),
                            ],
                          )
                        ),),
...
//                        color: Colors.blue[50],
                        ...
                        child: Text(_mealData['text']),
                      ),

                      Container(
 //                       color: Colors.lightGreen[300],
                        child: _FooterButtons(_mealData),
                      ),
                    ],
                  ),
                )
